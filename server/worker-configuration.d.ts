/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 52c52b0f3ba8304c04a31c8800f82685)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	profile: D1Database;
	TRACKBEAR_API_KEY: string;
	JWT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRACKBEAR_API_KEY" | "JWT_SECRET">> {}
}
