/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: deedd8fc4c79c06492596cb4dabb634b)
// Runtime types generated with workerd@1.20260515.1 2026-01-20 
...
interface D1Meta {
    ...
    changes: number;
    /**
     * The region of the migrations instance that executed the query.
     */
    ...
    /**
     * True if-and-only-if the migrations instance that executed the query was the primary.
     */
    served_by_primary?: boolean;
    timings?: {
        /**
         * The duration of the SQL query execution by the migrations instance. It doesn't include any network time.
         */
...
interface Hyperdrive {
    /**
     * Connect directly to Hyperdrive as if it's your migrations, returning a TCP socket.
     *
    ...
    /*
     * The username to use when authenticating to your migrations via Hyperdrive.
     * Unlike the host and password, this will be the same every time
     */
    readonly user: string;
    /*
     * The randomly generated password to use when authenticating to your
     * migrations via Hyperdrive. Like the host field, this password is only valid
     * within the context of the currently running Worker instance from which
     * it's read.
     */
    readonly password: string;
    /*
     * The name of the migrations to connect to.
     */
